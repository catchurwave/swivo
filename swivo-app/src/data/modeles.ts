/*
  Modèles juridiques & administratifs — micro-entreprise.
  Templates orientés démarches du quotidien : déclarations INPI, lettres,
  documents web (mentions légales, RGPD), contrats prestation, CGV.
*/

export type TemplateCategory = 'Démarches INPI' | 'Lettres' | 'Site web' | 'Contrats' | 'Attestations';
...
export type Template = {
  ...
  fields: { key: string; label: string; placeholder?: string; type?: 'text' | 'textarea' | 'date' | 'email' }[];
};
...
export const CATEGORIES: TemplateCategory[] = ['Démarches INPI', 'Attestations', 'Lettres', 'Site web', 'Contrats'];
